  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <p className="text-neutral-400 text-sm max-w-xs leading-relaxed">Describe what you want to build — buttons, forms, cards, layouts, and more.</p>
      </div>
    );
  }
          ...
          >
            {message.role === "assistant" && (
              <div className="flex-shrink-0 mb-0.5">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-blue-700 shadow-sm flex items-center justify-center">
            ...
            {message.role === "user" && (
              <div className="flex-shrink-0 mb-0.5">
                <div className="w-8 h-8 rounded-lg bg-neutral-800 shadow-sm flex items-center justify-center">
